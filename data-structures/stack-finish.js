...
StackString.prototype.pop = function() {
  ...
  var str = this.storage.slice(index + 3);
...
StackString.prototype.peek = function() {
  //implement me
}//Time complexity

StackString.prototype.count = function() {
  //implement me
}//Time complexity


var newStackMenu = new StackString();

newStackMenu.push('RedBeans');
newStackMenu.push('Banana');
newStackMenu.push('Mango');
...
// }
//
// var stackMenu = new Stack(5);
// stackMenu.push('Banana');
// stackMenu.push('Mango');
// stackMenu.push('RedBeans');
